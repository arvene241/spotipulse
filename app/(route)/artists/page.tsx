  ...
  return (
    <>
      <header className="md:flex block justify-between items-center">
        <h2 className="font-black text-2xl text-center md:text-start">Top Artists</h2>
              ...
              >
                ...
                >
                  <div className="relative">
                    <Image src={item.images[0].url} alt={item.name} width="300" height="300" className="w-[150px] h-[150px] md:w-[200px] md:h-[200px] rounded-full object-cover" />
