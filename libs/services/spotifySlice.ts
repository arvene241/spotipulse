import { ArtistItems, FollowingArtists, Playlists, RecentlyPlayed, SpotifyUser, TopArtists, TopTracks } from "@/types/types";
...
export const spotifyApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getArtist: builder.query<ArtistItems, string>({
